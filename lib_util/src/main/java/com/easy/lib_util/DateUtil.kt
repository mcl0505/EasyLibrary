...
object DateUtil {
    ...
    fun formatMDHM_(time:String): String {
        return SimpleDateFormat("MM-dd HH:mm", Locale.getDefault()).format(parseTime(time,"yyyy-MM-dd HH:mm"))
    }
    ...
    fun formatYMD_(str:String): String {
        return SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(parseTime(str))
    }

    fun formatHM_(): String {
    ...
    fun formatHM_(date: Date): String {
        return SimpleDateFormat("HH:mm", Locale.getDefault()).format(date)
    }
